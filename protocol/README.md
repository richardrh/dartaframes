...
execute Polars 0.55.2 native lazy sinks synchronously against the destination.
The binding adds no temporary-file replacement or rollback policy; failed
writes may leave partial output.
